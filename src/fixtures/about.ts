export const aboutData = {
   ...
   Front-end Development, JavaScript, Single Page Applications, Web Design,
   Web Components, RESTful & APIs and more…
   
   I believe that the truly great experiences come from an ambitious,
   innovative and up to date expertise. My designs can assure your next
